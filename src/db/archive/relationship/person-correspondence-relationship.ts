...
export async function createPersonRelationship(correspondenceID: string, personID: string, relationshipType: RelationshipType): Promise<Correspondence | undefined>{
...
export async function deletePersonRelationship(correspondenceID: string, personID: string, relationshipType: RelationshipType): Promise<Correspondence | undefined>{
...
export async function getPersonsByCorrespondence(correspondenceID: string, relationshipType: RelationshipType): Promise<Person[]>{
    ...
    const match = await getRelationshipsToNode(new Node(NodeType.CORRESPONDENCE, 'correspondenceID', correspondenceID), NodeType.PERSON, relationshipType, RelationshipDirection.COMING);
