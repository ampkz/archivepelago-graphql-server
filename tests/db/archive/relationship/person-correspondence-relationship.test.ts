...
import { createPersonRelationship, deletePersonRelationship, getCorrespondencesByPerson, getPersonsByCorrespondence } from '../../../../src/db/archive/relationship/person-correspondence-relationship';
...
describe(`CRUD Correspondence Tests`, () => {
    ...
    it(`should create a relationship between a created person and a created correspondence`, async () => {
        ...
        const returnedCorrespondence = await createPersonRelationship(createdCorrespondence?.correspondenceID as string, createdPerson.id, RelationshipType.SENT);
    ...
    it(`should delete a created relationship between a created person and a created correspondence`, async () => {
        ...
        const returnedCorrespondence = await deletePersonRelationship(createdCorrespondence?.correspondenceID as string, createdPerson.id, RelationshipType.SENT);
